...
namespace Pixeye.Unity
{
    ...
    public class EditorOverride : CustomEditorSelector
    {
        //===============================//
        // Members
        //===============================//
        ...
        public void OnDisable(object target, Editor editor)
        {
            ...
            if (target != null)
                ...
                {
                    if (c.Value.props.Count == 0) continue;
        ...
        public void OnInspectorGUI(object target, Editor editor)
        {
            ...
            void Body()
            {
                ...
                {
                    editor.UseVerticalLayout(() => Foldout(pair.Value), StyleFramework.box);
            ...
            void Foldout(CacheFoldProp cache)
            {
                ...
                if (cache.expanded)
                {
                    ...
                    {
                        editor.UseVerticalLayout(() => Child(i), StyleFramework.boxChild);
                    }
                }
