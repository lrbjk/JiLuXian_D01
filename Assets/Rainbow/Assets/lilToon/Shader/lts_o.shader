Shader "Hidden/lilToonOutline"
{
    Properties
    {
        ...
        _BackfaceColor ("sColor", Color) = (0,0,0,0)
        ...
        _Main2ndDissolveColor ("sColor", Color) = (1,1,1,1)
        ...
        _Main3rdDissolveColor ("sColor", Color) = (1,1,1,1)
        ...
        _RimShadeFresnelPower ("sFresnelPower", Range(0.01, 50)) = 1.0
        ...
        // Reflectance
        _Reflectance ("sReflectance", Range(0, 1)) = 0.04
        // Reflection
        ...
        _ReflectionCubeColor ("sColor", Color) = (0,0,0,1)
        ...
        _MatCapColor ("sColor", Color) = (1,1,1,1)
        _MatCapTex ("Texture", 2D) = "white" {}
        _MatCapMainStrength ("sMainColorPower", Range(0, 1)) = 0
        _MatCapBlendUV1 ("sBlendUV1", Vector) = (0,0,0,0)
        _MatCapZRotCancel ("sMatCapZRotCancel", Int) = 1
        _MatCapPerspective ("sFixPerspective", Int) = 1
        ...
        _MatCapBackfaceMask ("sBackfaceMask", Int) = 0
        ...
        _MatCap2ndColor ("sColor", Color) = (1,1,1,1)
        ...
        _MatCap2ndZRotCancel ("sMatCapZRotCancel", Int) = 1
        _MatCap2ndPerspective ("sFixPerspective", Int) = 1
        ...
        _MatCap2ndBackfaceMask ("sBackfaceMask", Int) = 0
        ...
        _RimIndirColor ("sColor", Color) = (1,1,1,1)
        ...
        _GlitterUVMode ("UV Mode|UV0|UV1", Int) = 0
        ...
        //----------------------------------------------------------------------------------------------------------------------
        // Distance Fade
        _DistanceFadeColor ("sColor", Color) = (0,0,0,1)
        _DistanceFade ("sDistanceFadeSettings", Vector) = (0.1,0.01,0,0)
        _DistanceFadeMode ("sDistanceFadeModes", Int) = 0
        _DistanceFadeRimColor ("sColor", Color) = (0,0,0,0)
        _DistanceFadeRimFresnelPower ("sFresnelPower", Range(0.01, 50)) = 5.0

        //----------------------------------------------------------------------------------------------------------------------
        // AudioLink
        _UseAudioLink ("sAudioLink", Int) = 0
        _AudioLinkDefaultValue ("Strength|Blink Strength|Blink Speed|Blink Threshold", Vector) = (0.0,0.0,2.0,0.75)
        _AudioLinkUVMode ("sAudioLinkUVModes", Int) = 1
        _AudioLinkUVParams ("Scale|Offset|sAngle|Band|Bass|Low Mid|High Mid|Treble", Vector) = (0.25,0,0,0.125)
        _AudioLinkStart ("sAudioLinkStartPosition", Vector) = (0.0,0.0,0.0,0.0)
        _AudioLinkMask ("Mask", 2D) = "blue" {}
        _AudioLinkMask_ScrollRotate ("sScrollRotates", Vector) = (0,0,0,0)
        _AudioLinkMask_UVMode ("UV Mode|UV0|UV1|UV2|UV3", Int) = 0
        _AudioLink2Main2nd ("sMainColor2nd", Int) = 0
        _AudioLink2Main3rd ("sMainColor3rd", Int) = 0
        _AudioLink2Emission ("sEmission", Int) = 0
        _AudioLink2EmissionGrad ("sEmission+sGradation", Int) = 0
        _AudioLink2Emission2nd ("sEmission2nd", Int) = 0
        _AudioLink2Emission2ndGrad ("sEmission2nd+sGradation", Int) = 0
        _AudioLink2Vertex ("sVertex", Int) = 0
        _AudioLinkVertexUVMode ("sAudioLinkVertexUVModes", Int) = 1
        _AudioLinkVertexUVParams ("Scale|Offset|sAngle|Band|Bass|Low Mid|High Mid|Treble", Vector) = (0.25,0,0,0.125)
        _AudioLinkVertexStart ("sAudioLinkStartPosition", Vector) = (0.0,0.0,0.0,0.0)
        _AudioLinkVertexStrength ("sAudioLinkVertexStrengths", Vector) = (0.0,0.0,0.0,1.0)
        _AudioLinkAsLocal ("sAudioLinkAsLocal", Int) = 0
        _AudioLinkLocalMap ("Local Map", 2D) = "black" {}
        _AudioLinkLocalMapParams ("sAudioLinkLocalMapParams", Vector) = (120,1,0,0)
        ...
        _DissolveColor ("sColor", Color) = (1,1,1,1)
        ...
        _IDMaskCompile ("_IDMaskCompile", Int) = 0
        _IDMaskFrom ("_IDMaskFrom|0: UV0|1: UV1|2: UV2|3: UV3|4: UV4|5: UV5|6: UV6|7: UV7|8: VertexID", Int) = 8
        _IDMask1 ("_IDMask1", Int) = 0
        _IDMask2 ("_IDMask2", Int) = 0
        _IDMask3 ("_IDMask3", Int) = 0
        _IDMask4 ("_IDMask4", Int) = 0
        _IDMask5 ("_IDMask5", Int) = 0
        _IDMask6 ("_IDMask6", Int) = 0
        _IDMask7 ("_IDMask7", Int) = 0
        _IDMask8 ("_IDMask8", Int) = 0
        _IDMaskIsBitmap ("_IDMaskIsBitmap", Int) = 0
        ...
        _IDMaskControlsDissolve ("_IDMaskControlsDissolve", Int) = 0
        _IDMaskPrior1 ("_IDMaskPrior1", Int) = 0
        _IDMaskPrior2 ("_IDMaskPrior2", Int) = 0
        _IDMaskPrior3 ("_IDMaskPrior3", Int) = 0
        _IDMaskPrior4 ("_IDMaskPrior4", Int) = 0
        _IDMaskPrior5 ("_IDMaskPrior5", Int) = 0
        _IDMaskPrior6 ("_IDMaskPrior6", Int) = 0
        _IDMaskPrior7 ("_IDMaskPrior7", Int) = 0
        _IDMaskPrior8 ("_IDMaskPrior8", Int) = 0

        //----------------------------------------------------------------------------------------------------------------------
        // UDIM Discard
        _UDIMDiscardCompile ("sUDIMDiscard", Int) = 0
        _UDIMDiscardUV ("sUDIMDiscardUV|0: UV0|1: UV1|2: UV2|3: UV3", Int) = 0
        _UDIMDiscardMode ("sUDIMDiscardMode|0: Vertex|1: Pixel (slower)", Int) = 0
        ...
        //----------------------------------------------------------------------------------------------------------------------
        // Encryption
        _IgnoreEncryption ("sIgnoreEncryption", Int) = 0
        ...
        _OutlineLitColor ("sColor", Color) = (1.0,0.2,0,0)
        ...
        _TessFactorMax ("sTessellationFactor", Range(1, 8)) = 3

        //----------------------------------------------------------------------------------------------------------------------
        // For Multi
        _UseOutline ("Use Outline", Int) = 0
        _TransparentMode ("Rendering Mode|Opaque|Cutout|Transparent|Refraction|Fur|FurCutout|Gem", Int) = 0
        _UseClippingCanceller ("sSettingClippingCanceller", Int) = 0
        _AsOverlay ("sAsOverlay", Int) = 0

        //----------------------------------------------------------------------------------------------------------------------
        // Save (Unused)
        _BaseColor ("sColor", Color) = (1,1,1,1)
        _BaseMap ("Texture", 2D) = "white" {}
        _BaseColorMap ("Texture", 2D) = "white" {}
        _lilToonVersion ("Version", Int) = 45
